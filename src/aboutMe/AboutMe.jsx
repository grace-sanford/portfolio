        ...
        <Container>
          <div className="text">
            ...
            <p>
              ...
              building{" "}
              <span className="pink">technology that helps people</span>. Grace
              has experience in fast-paced, client-facing roles, as a Marketing
              Strategist for a gut-health podcast, an Assistant Publicist for
              business and non-fiction authors, and most recently a
              reservationist for an upscale bar and restaurant, where she
              designed and implemented a single system for tracking 1000+
              clients accross 3 platforms and 4 businesses. Grace holds a B.A.
              in Sociology, with a cerficate in Social, Cultural, and Critical
              Theory from Wesleyan University. Grace lives in New York City.
            </p>
          </div>
        </Container>
      </div>
